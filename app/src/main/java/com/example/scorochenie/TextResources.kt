...
object TextResources {
    ...
    val keyWords = listOf(
        listOf(
            "Зелёные растения", "пищу", "фотосинтезом",
            "кислород", "животные", "клетки",
            "корень", "стебель", "водоросли",
            "суше", "лишайники", "мхи",
            "почвы", "папоротники", "цветковые растения",
            "тропических лесах", "Центральной и Южной Америки", "тропической Африки",
            "Великобритании", "планете", "люди",
            "пища", "топливо", "пространство для жизни"
        ),
        listOf(
            "радио", "человека", "звука","звуковой",
            "передатчик", "передатчика","передатчиков","радиоприёмник", "радиоволны","радиоволнами","радиоволн",
            "микрофон", "микрофона","электрические сигналы", "антенне",
            "частота", "шкале настройки", "частоты",
            "радиотелефон", "корабли", "самолёты",
            "телевидение", "ионосферой", "скоростью"
        ),
        listOf(
            "Радар","радара", "радары", "радарами","объекта",  "радарной тарелке", "авиадиспетчеров",
            "самолёта", "самолётах","прогнозирования погоды", "микроволны",
            "передатчик", "приёмное устройство", "лазерная установка",
            "местонахождение", "антенны", "судна",
            "Роберт Ватсон-Ватт", "\"лучи смерти\"", "Вторая мировая война"
        )
    )
}