    ...
    override fun onCreateView(
        ...
        val description = when (techniqueName) {
            ...
            "Зигзагообразное чтение" -> {
                val text = "Зигзагообразное чтение — это техника скорочтения, при которой взгляд движется по тексту зигзагообразной траекторией, захватывая ключевые слова и фразы. Этот метод позволяет быстро охватить широкие текстовые блоки, игнорируя второстепенные детали.\n" +
                        "Для применения методики перемещайте взгляд зигзагом от одной стороны страницы к другой, фиксируя основные идеи текста.\n" +
                        "Сосредоточьтесь на выделенных словах, заголовках и ключевых фразах, чтобы быстро уловить суть материала без лишних затрат времени."
                val spannable = SpannableString(text)

                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Зигзагообразное чтение".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("перемещайте взгляд зигзагом"), text.indexOf("перемещайте взгляд зигзагом") + "перемещайте взгляд зигзагом".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("основные идеи текста"), text.indexOf("основные идеи текста") + "основные идеи текста".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("выделенных словах, заголовках и ключевых фразах"), text.indexOf("выделенных словах, заголовках и ключевых фразах") + "выделенных словах, заголовках и ключевых фразах".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            "Вертикальное чтение" -> {
                ...
                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Вертикальное чтение".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("ведите взгляд строго вертикально"), text.indexOf("ведите взгляд строго вертикально") + "ведите взгляд строго вертикально".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("центральные слова строк"), text.indexOf("центральные слова строк") + "центральные слова строк".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("ключевых терминах и фразах"), text.indexOf("ключевых терминах и фразах") + "ключевых терминах и фразах".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            "Поиск ключевых слов" -> {
                ...
                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Поиск ключевых слов".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            "Чтение \"блоками\"" -> {
                ...
                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Чтение \"блоками\"".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("захватывайте взглядом группы слов"), text.indexOf("захватывайте взглядом группы слов") + "захватывайте взглядом группы слов".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("смысловые фрагменты"), text.indexOf("смысловые фрагменты") + "смысловые фрагменты".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("целостных идеях"), text.indexOf("целостных идеях") + "целостных идеях".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            "Периферийное чтение" -> {
                ...
                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Периферийное чтение".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("расширяйте поле зрения"), text.indexOf("расширяйте поле зрения") + "расширяйте поле зрения".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("боковое зрение"), text.indexOf("боковое зрение") + "боковое зрение".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("восприятия соседних слов"), text.indexOf("восприятия соседних слов") + "восприятия соседних слов".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            "Обратное чтение" -> {
                ...
                spannable.setSpan(StyleSpan(Typeface.BOLD), 0, "Обратное чтение".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("начните с последнего абзаца"), text.indexOf("начните с последнего абзаца") + "начните с последнего абзаца".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("основные выводы"), text.indexOf("основные выводы") + "основные выводы".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                spannable.setSpan(StyleSpan(Typeface.BOLD), text.indexOf("главных тезисах"), text.indexOf("главных тезисах") + "главных тезисах".length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)

                spannable
            }
            "Метод \"указки\"" -> "Метод \"указки\" — это техника скорочтения, при которой используется палец, ручка или другой указатель для направления взгляда по тексту. Метод помогает поддерживать ритм чтения и избегать возвращений назад.\n" +
